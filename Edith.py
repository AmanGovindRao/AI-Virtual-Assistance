...
def TaskExe():
    ...
    def OpenApps():
        ...
        if 'code' in query:
            os.startfile("C:\\Users\\AmanRajput\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe")
            Speak("opening code")

        elif 'whatsapp' in query:
            os.startfile("C:\\Users\\AmanRajput\\AppData\\Local\\WhatsApp\\WhatsApp.exe")
    ...
    def whatsapp():
        ...
        if 'Home' in name:
            ...
            Speak("ok sir, message is sending to your airtel number")
            msg = takecommand()
            Speak("tell me the time sir")
            Speak("time in hour!")
            hour = int(takecommand())
    ...
    def screenshot():
        ...
        path = takecommand()
        path1name = path + ".png"
        path1 = "C:\\Users\\AmanRajput\\Pictures\\SS\\"+ path1name
        kk = pyautogui.screenshot()
        kk.save(path1)
        os.startfile("C:\\Users\\AmanRajput\\Pictures\\SS\\")
    ...
    while True:
        ...
        if 'hello' in query or 'hello jarvis' in query or 'hello edith' in query or 'hii jarvis' in query or 'hii edith' in query:
            ...
            Speak("ok sir, showing Biru bhaiya ka photo")
...
if __name__ == "__main__":
    while True:
        ...
        if "activate jarvis" in Permission or "activate" in Permission or 'jarvis come on' in Permission or 'edith come on' in Permission or 'edith activate' in Permission or 'activate edith' in Permission or 'come on' in Permission or 'lets start' in Permission or 'start' in Permission or 'start karo edith' in Permission or 'start karo jarvis' in Permission:
            wish()
            TaskExe()

        elif "wake up" in Permission or "wake up jarvis" in Permission or "Hey jarvis" in Permission or "come back jarvis" in Permission  or "come jarvis" in Permission or "wake up edith" in Permission or "come back edith" in Permission  or "come edith" in Permission or "wapas aa jao jarvis" in Permission or "wapas a jao" in Permission:
            print("Welcome Back Sir")
            Speak("Welcome Back Sir")
            TaskExe()

        elif "bye jarvis" in Permission or "bye" in Permission or "bye edith" in Permission or "exit" in Permission or "you need to go" in Permission or "you need to go edith" in Permission or "you need to go jarvis" in Permission:
